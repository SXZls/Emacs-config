...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Unifont" :foundry "outline" :slant normal :weight medium :height 130 :width normal)))))
 ;; cosmic latte color
(set-background-color "#FFF8E7")
...
;; clang C/C++
;;;;;;;;;;;;;;;;
(add-to-list 'eglot-server-programs '((c++-mode c-mode) "gcc"))
